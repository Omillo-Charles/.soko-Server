...
shopRouter.put("/my-shop/branding", authorize, upload.fields([
    { name: 'avatar', maxCount: 1 },
    { name: 'banner', maxCount: 1 }
]), validateImageUpload, validate(updateShopSchema), updateShop);
...
shopRouter.post("/handle/:username/rate", authorize, createLimiter, rateShopByHandle);
...
shopRouter.post("/:id/rate", authorize, createLimiter, rateShop);
